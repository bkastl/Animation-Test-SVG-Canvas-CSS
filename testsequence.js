...

{
	...
	var tests = [ 
		...
		{id: 35, object: "Particle", maxObjects: 1000, type: "webgl", description: "Canvas (WebGL)", required: ["canvas","webgl"]},
		{id: 36, object: "Particle", maxObjects: 2500, type: "webgl", description: "Canvas (WebGL)", required: ["canvas","webgl"]},
		{id: 37, object: "Particle", maxObjects: 5000, type: "webgl", description: "Canvas (WebGL)", required: ["canvas","webgl"]},
		...
		{id: 86, object: "Sprite", maxObjects: 25, type: "canvassvg", description: "Canvas 2D (Spritefile SVG)", required: "canvas, svg", imageAsset: 2},
		{id: 87, object: "Sprite", maxObjects: 25, type: "canvas", description: "Canvas 2D (Spritefile PNG)", required: ["canvas"], imageAsset: 1},
		...
		{id: 90, object: "Sprite", maxObjects: 100, type: "canvas", description: "Canvas 2D (Spritefile PNG)", required: ["canvas"], imageAsset: 1},
		...
		{id: 94, object: "Sprite", maxObjects: 250, type: "canvas", description: "Canvas 2D (Spritefile PNG)", required: ["canvas"], imageAsset: 1},
		{id: 95, object: "Sprite", maxObjects: 1000, type: "canvas", description: "Canvas 2D (Spritefile PNG)", required: ["canvas"], imageAsset: 1},
		{id: 96, object: "Sprite", maxObjects: 1000, type: "canvasbuffer", description: "Canvas 2D (Spritefile PNG)", required: ["canvas"], imageAsset: 1},
		{id: 97, object: "Sprite", maxObjects: 5000, type: "canvas", description: "Canvas 2D (Spritefile PNG)", required: ["canvas"], imageAsset: 1},
		{id: 98, object: "Sprite", maxObjects: 7500, type: "canvas", description: "Canvas 2D (Spritefile PNG)", required: ["canvas"], imageAsset: 1},
		{id: 99, object: "Sprite", maxObjects: 7500, type: "canvasbuffer", description: "Canvas 2D (Spritefile PNG)", required: ["canvas"], imageAsset: 1},
		{id: 100, object: "Sprite", maxObjects: 1000, type: "webgl", description: "Canvas (WebGL)", required: ["canvas","webgl"], imageAsset: "assets/json/spritesheet.json"},
		{id: 101, object: "Sprite", maxObjects: 5000, type: "webgl", description: "Canvas (WebGL)", required: ["canvas","webgl"], imageAsset: "assets/json/spritesheet.json"},
		{id: 102, object: "Sprite", maxObjects: 15000, type: "webgl", description: "Canvas (WebGL)", required: ["canvas","webgl"], imageAsset: "assets/json/spritesheet.json"}
	];
 return tests;
}
